function stabilization_webcam_func_py(numframes)


v = imaq.VideoDevice('winvideo', 1); % выбор устройства для получения видеопотока
v.ReturnedColorSpace = 'grayscale'; % выбор режима цветопередачи "оттенки серого"
